...
*/
DLLEXPORT MOCKABLE_FUNCTION(, COND_HANDLE, Condition_Init);
...
*/
DLLEXPORT MOCKABLE_FUNCTION(, COND_RESULT, Condition_Post, COND_HANDLE, handle);
...
* 			and @c COND_TIMEOUT when the handle times out.
*/
DLLEXPORT MOCKABLE_FUNCTION(, COND_RESULT, Condition_Wait, COND_HANDLE, handle, LOCK_HANDLE, lock, int, timeout_milliseconds);
...
* 			destroyed and @c COND_ERROR when an error occurs.
*/
DLLEXPORT MOCKABLE_FUNCTION(, void, Condition_Deinit, COND_HANDLE, handle);
