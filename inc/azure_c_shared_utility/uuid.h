...
*/
DLLEXPORT MOCKABLE_FUNCTION(, int, UUID_generate, UUID*, uuid);
...
*  @returns             Zero if no failures occur, non-zero otherwise.
*/
DLLEXPORT MOCKABLE_FUNCTION(, int, UUID_from_string, const char*, uuid_string, UUID*, uuid);
...
*/
DLLEXPORT MOCKABLE_FUNCTION(, char*, UUID_to_string, UUID*, uuid);
