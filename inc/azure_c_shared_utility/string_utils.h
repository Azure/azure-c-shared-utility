...
//#define GUID_VALUES(guid) (guid).Data1, (guid).Data2, (guid).Data3, (((uint64_t)((guid).Data4[0]))<<8) + (guid).Data4[1], (((uint64_t)((guid).Data4[2]))<<40) + (((uint64_t)((guid).Data4[3]))<<32) + (((uint64_t)((guid).Data4[4]))<<24) + (((uint64_t)((guid).Data4[5]))<<16) + (((uint64_t)((guid).Data4[6]))<<8) + ((guid).Data4[7])
#define GUID_VALUES(guid) (guid).Data1, (guid).Data2, (guid).Data3, 0 + (guid).Data4[1], (uint64_t)0
