 ...
 */
DLLEXPORT MOCKABLE_FUNCTION(, THREADAPI_RESULT, ThreadAPI_Create, THREAD_HANDLE*, threadHandle, THREAD_START_FUNC, func, void*, arg);
 ...
 * 			code in case it fails.
 */
DLLEXPORT MOCKABLE_FUNCTION(, THREADAPI_RESULT, ThreadAPI_Join, THREAD_HANDLE, threadHandle, int*, res);
 ...
 */
DLLEXPORT MOCKABLE_FUNCTION(, void, ThreadAPI_Exit, int, res);
 ...
 */
DLLEXPORT MOCKABLE_FUNCTION(, void, ThreadAPI_Sleep, unsigned int, milliseconds);
