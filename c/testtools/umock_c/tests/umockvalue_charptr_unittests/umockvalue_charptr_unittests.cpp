...
TEST_FUNCTION(umockvalue_are_equal_charptr_with_string_being_the_same_returns_1)
{
    // arrange
...
TEST_FUNCTION(umockvalue_are_equal_charptr_with_string_being_different_returns_0)
{
    // arrange
    char* input1 = (char*)malloc(7);
    char* input2 = (char*)malloc(7);
...
TEST_FUNCTION(umockvalue_are_equal_charptr_with_string_being_different_in_case_returns_0)
{
    // arrange
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_019: [ umockvalue_stringify_const_charptr shall return a string containing the string representation of value, enclosed by quotes (\"value\"). ] */
TEST_FUNCTION(umockvalue_stringify_const_charptr_with_an_empty_string_returns_2_quotes)
{
    // arrange
    char* input = "";

    // act
    char* result = umockvalue_stringify_const_charptr((const char**)&input);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_019: [ umockvalue_stringify_const_charptr shall return a string containing the string representation of value, enclosed by quotes (\"value\"). ] */
TEST_FUNCTION(umockvalue_stringify_const_charptr_with_a_non_empty_string_returns_the_string_surrounded_by_quotes)
{
    // arrange
    const char* input = "test42";

    // act
    char* result = umockvalue_stringify_const_charptr(&input);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_020: [ If value is NULL, umockvalue_stringify_const_charptr shall return NULL. ]*/
TEST_FUNCTION(umockvalue_stringify_const_charptr_with_NULL_argument_returns_NULL)
{
    // arrange

    // act
    char* result = umockvalue_stringify_const_charptr(NULL);
...
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_same_pointer_returns_1)
{
    ...
    // act
    int result = umockvalue_are_equal_const_charptr(&input, &input);
...
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_same_NULL_pointer_returns_1)
{
    ...
    // act
    int result = umockvalue_are_equal_const_charptr(NULL, NULL);

    // assert
    ASSERT_ARE_EQUAL(int, 1, result);
}

/* Tests_SRS_UMOCKVALUE_CHARPTR_01_025: [ If only one of the left and right argument is NULL, umockvalue_are_equal_const_charptr shall return 0. ] */
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_left_NULL_returns_0)
{
    // arrange
    const char* input = "test42";

    // act
    int result = umockvalue_are_equal_const_charptr(NULL, &input);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_025: [ If only one of the left and right argument is NULL, umockvalue_are_equal_const_charptr shall return 0. ] */
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_right_NULL_returns_0)
{
    // arrange
    const char* input = "test42";

    // act
    int result = umockvalue_are_equal_const_charptr(&input, NULL);

    // assert
    ASSERT_ARE_EQUAL(int, 0, result);
}

/* Tests_SRS_UMOCKVALUE_CHARPTR_01_026: [ If the string pointed to by left is equal to the string pointed to by right, umockvalue_are_equal_const_charptr shall return 1. ]*/
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_string_being_the_same_returns_1)
{
    // arrange
    char* input1 = (char*)malloc(7);
    char* input2 = (char*)malloc(7);
    ...
    // act
    int result = umockvalue_are_equal_const_charptr((const char**)&input1, (const char**)&input2);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_027: [ If the string pointed to by left is different than the string pointed to by right, umockvalue_are_equal_const_charptr shall return 0. ]*/
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_string_being_different_returns_0)
{
    // arrange
    char* input1 = (char*)malloc(7);
    char* input2 = (char*)malloc(7);
...
TEST_FUNCTION(umockvalue_are_equal_const_charptr_with_string_being_different_in_case_returns_0)
{
    // arrange
    char* input1 = (char*)malloc(5);
    char* input2 = (char*)malloc(5);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_028: [ umockvalue_copy_const_charptr shall allocate a new sequence of chars by using malloc. ]*/
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_029: [ The number of bytes allocated shall accomodate the string pointed to by source. ]*/
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_032: [ On success umockvalue_copy_const_charptr shall return 0. ]*/
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_030: [ umockvalue_copy_const_charptr shall copy the string pointed to by source to the newly allocated memory. ]*/
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_031: [ The newly allocated string shall be returned in the destination argument. ]*/
TEST_FUNCTION(umockvalue_copy_const_charptr_copies_an_empty_string)
{
    // arrange
    const char* source = "";
    char* destination = "a";
    ...
    // act
    int result = umockvalue_copy_const_charptr(&destination, &source);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_030: [ umockvalue_copy_const_charptr shall copy the string pointed to by source to the newly allocated memory. ]*/
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_031: [ The newly allocated string shall be returned in the destination argument. ]*/
TEST_FUNCTION(umockvalue_copy_const_charptr_copies_a_string)
{
    // arrange
    const char* source = "test42";
    char* destination = "a";
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_033: [ If source or destination are NULL, umockvalue_copy_const_charptr shall return a non-zero value. ]*/
TEST_FUNCTION(umockvalue_copy_const_charptr_with_NULL_destination_fails)
{
    // arrange
    const char* source = "42";

    // act
    int result = umockvalue_copy_const_charptr(NULL, &source);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_033: [ If source or destination are NULL, umockvalue_copy_const_charptr shall return a non-zero value. ]*/
TEST_FUNCTION(umockvalue_copy_const_charptr_with_NULL_source_fails)
{
    // arrange
    char* destination = "a";

    // act
    int result = umockvalue_copy_const_charptr(&destination, NULL);
...
/* Tests_SRS_UMOCKVALUE_CHARPTR_01_034: [ umockvalue_free_const_charptr shall free the string pointed to by value. ]*/
TEST_FUNCTION(umockvalue_free_const_charptr_frees_the_string)
{
    // arrange
    const char* source = "test42";
    char* destination = "a";

    (void)umockvalue_copy_const_charptr(&destination, &source);

    // act
    umockvalue_free_const_charptr(&destination);

    // assert
    // no explicit assert
}

/* Tests_SRS_UMOCKVALUE_CHARPTR_01_035: [ If value is NULL, umockvalue_free_const_charptr shall do nothing. ] */
TEST_FUNCTION(umockvalue_free_const_charptr_with_NULL_does_nothing)
{
    // arrange

    // act
    umockvalue_free_const_charptr(NULL);
