...
function(set_platform_files c_shared_dir)
    if(WIN32)
        ...
        if (${use_socketio})
            ...
            set(SOCKET_LISTENER_C_FILE ${c_shared_dir}/adapters/socket_listener_win32.c PARENT_SCOPE)
        endif()
        ...
        if (${use_socketio})
			...
			set(SOCKET_LISTENER_C_FILE ${c_shared_dir}/adapters/socket_listener_berkeley.c PARENT_SCOPE)
        endif()
