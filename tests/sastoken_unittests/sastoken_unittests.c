...
TEST_FUNCTION(SASToken_Create_size_tToString_fails)
{
    ...
    STRICT_EXPECTED_CALL(size_tToString(IGNORED_PTR_ARG, sizeof(TEST_TOKEN_EXPIRATION_TIME), TEST_EXPIRY)).IgnoreArgument(1).SetReturn(1);
...
TEST_FUNCTION(SASToken_Create_buffer_new_fails)
{
    ...
    STRICT_EXPECTED_CALL(size_tToString(IGNORED_PTR_ARG, sizeof(TEST_TOKEN_EXPIRATION_TIME), TEST_EXPIRY)).IgnoreArgument(1).CopyOutArgumentBuffer(1, TEST_TOKEN_EXPIRATION_TIME, sizeof(TEST_TOKEN_EXPIRATION_TIME) ,0);
    STRICT_EXPECTED_CALL(BUFFER_new()).SetReturn(TEST_NULL_BUFFER_HANDLE);
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE));
    STRICT_EXPECTED_CALL(BUFFER_delete(TEST_NULL_BUFFER_HANDLE));
...
TEST_FUNCTION(SASToken_Create_first_string_new_fails)
{
    ...
    STRICT_EXPECTED_CALL(STRING_new()).SetReturn(TEST_NULL_STRING_HANDLE);
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE));
...
TEST_FUNCTION(SASToken_Create_HMAC256_fails)
{
    ...
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE)); // base64
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE)); // url signature
...
TEST_FUNCTION(SASToken_Create_HMAC256_passes_signature_encode_fails)
{
    ...
    STRICT_EXPECTED_CALL(Base64_Encode(TEST_HASH_HANDLE)).SetReturn(TEST_NULL_STRING_HANDLE);
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE)); //base64
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE)); //url signature
...
TEST_FUNCTION(SASToken_Create_building_token_signature_url_encoding_fails)
{
    ...
    STRICT_EXPECTED_CALL(URL_Encode(TEST_BASE64SIGNATURE_HANDLE)).SetReturn(TEST_NULL_STRING_HANDLE);
    STRICT_EXPECTED_CALL(STRING_delete(TEST_NULL_STRING_HANDLE));
